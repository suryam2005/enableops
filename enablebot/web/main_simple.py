"""
EnableOps Web Interface - Simplified Version
Basic version without Prisma dependencies for initial deployment
"""
...
async def startup_event():
    ...
    logger.info("🚀 Starting EnableOps Web Application (Simple Mode)...")
